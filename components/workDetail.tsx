  ...
  return (
    <AnimatePresence>
      <div className="flex justify-center">
        <div className="fixed flex justify-center items-center lg:top-[26rem] xl:top-[28rem] top-96">
          <motion.div
            variants={variants}
            initial={"initial"}
            animate={id ? "toggled" : ""}
          ...
          >
            <img
              alt="project"
              src={`/${id}.gif`}
              className="shadow-2xl  lg:w-[30rem] lg:h-[30rem] xl:w-[40rem] xl:h-[40rem] w-80 h-80 mb-4"
            />
                  ...
                  >
                    ...
                    >
                      <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="w-6 h-6 lg:w-8 lg:h-8 mx-10"
                      >
                        <motion.path
                          initial={{ pathLength: 0, fill: "none", opacity: 0 }}
                          animate={{

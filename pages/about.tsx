        ...
        <div className="md:mx-20 mx-4 ">
          <div className="">
            <div className="space-y-8 mb-32 lg:w-[40vw] flex justify-center lg:justify-start flex-col font-light text-gray-600">
              ...
              >
                ...
                <p>
                  ...
                  되었습니다. 모두가 당연히 가야 한다고 말하던 학교도 또 하나의
                  선택일 뿐이었다는 것을.
                </p>
              </motion.div>
            </div>
            <div className="space-y-8 flex flex-col lg:items-end font-light text-gray-600 mb-32">
              ...
              >
                ...
                <p className="lg:w-[40vw]">
                  ...
                  귀국한 이후 회사 생활까지 연이어 다양한 경험을 하였으며 노력과
                  결과에 대한 성취 또한 느끼게 되었습니다.
                </p>
                <p className="lg:w-[40vw]">
                  저는 제 선택들로 얻은 차별화된 경험으로 역량을 키울 수 있었고
                  더 나은 퍼포먼스를 보여줄 수 있게 되었다고 생각합니다.
                </p>
              </motion.div>
            </div>
            <div className="space-y-8  lg:w-[40vw] flex justify-center lg:justify-start flex-col font-light text-gray-600">
              ...
              >
                <p>
                  저는 실행력이 강하다고 자부합니다. 특히 어떠한 일을 행함으로써
                  실체가 있는 결과를 얻었을 때 실행력과 승부욕이 강해집니다.
                </p>
                ...
                <p>
                  ...
                  더욱 빛을 발할 것이고, 차츰차츰 앞으로 나아가 완성된 개발자가
                  될 것입니다.
                </p>
              </motion.div>
            </div>
